...
def test():
    num0, id0, label0, tweets0, friends0, favourites0 = process_users('cresci-2015', ['E13','TFP'],0) #human
    num1, id1, label1, tweets1, friends1, favourites1 = process_users('cresci-2015', ['FSF','INT','TWT'],1) #bot
    # 合并人类账户和机器账户
    num = num0 + num1
